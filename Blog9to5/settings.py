"""
Django settings for Blog9to5 project.
...
# SECRET_KEY = 'django-insecure-@%5ia5u8@7l$3!7s&_(pwf_%uqt)x6gy1t^ll+#_)*#sk3#d0='
...
WSGI_APPLICATION = 'Blog9to5.wsgi.application'
